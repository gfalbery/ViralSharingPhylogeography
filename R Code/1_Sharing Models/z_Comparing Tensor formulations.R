...
load("Output Files/TryList.Rdata")
load("Output Files/TryFitList.Rdata")

if(length(TryList[[1]])<8){
...
save(TryList, file = "Output Files/TryList.Rdata")
save(TryFitList, file = "Output Files/TryList.Rdata")
