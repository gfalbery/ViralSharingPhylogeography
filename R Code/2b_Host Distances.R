...
TestHosts <- merge(TestHosts, hHumanDist2[,c("Sp","HumanDist")], by = "Sp", all.x = T)
TestHosts <- merge(TestHosts, hDomDist2[,c("Sp", "MeanDomDist", "MinDomDist", "MaxDomDist")], by = "Sp", all.x = T)
