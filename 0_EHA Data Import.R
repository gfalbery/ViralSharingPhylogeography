...
source(paste0(funcroot, "/Bar Graph.R"))
source(paste0(funcroot, "/ggMMplot (Mosaic plot).R"))
source(paste0(funcroot, "/Model Effects Plot.R"))
source(paste0(funcroot, "/INLA Model Selection.R"))
source(paste0(funcroot, "/INLA Model Addition.R"))
